...
#SBATCH --exclusive
#SBATCH --job-name test_basic_cpu
#SBATCH --output logs/slurm-basic-cpu-test.log
#SBATCH --cpus-per-task=64
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=1
#SBATCH --constraint=xeon64c
...
python src/validation/nodes.py "logs/slurm-basic-cpu-test.log" 2
