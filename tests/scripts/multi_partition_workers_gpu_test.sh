...
#SBATCH --exclusive
#SBATCH --job-name ray_mp_workers_gpu
#SBATCH --output logs/ray-mp-workers-gpu-test.log
...
source src/scripts/setup_ray_workers.sh --gpus=2 --dir=$HOME/ray_tmp --index=0
